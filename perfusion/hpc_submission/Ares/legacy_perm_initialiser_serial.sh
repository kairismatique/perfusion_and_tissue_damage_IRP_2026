...
singularity exec \
    ...
    bash -c "
        ...
        && cd /mnt/project \
        && /usr/local/bin/activate-fenics-legacy python3 -m src.Legacy_version.simulation.permeability_initialiser --config_file ./configs/config_permeability_initialiser.yaml
    "