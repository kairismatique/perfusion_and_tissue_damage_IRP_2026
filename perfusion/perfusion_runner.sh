...
python3 -m src.Legacy_version.io.convert_res2img --config_file ./results/p0000/perfusion_LMCAo/settings.yaml
python3 -m src.Legacy_version.simulation.lesion_comp_from_img --healthy_file ./results/p0000/perfusion_healthy/perfusion.nii.gz --occluded_file ./results/p0000/perfusion_LMCAo/perfusion.nii.gz
mpirun -n 6 python3 -m src.Legacy_version.simulation.infarct_calculation_thresholds --config_file ./configs/config_basic_flow_solver_LMCAo.yaml --baseline ./results/p0000/perfusion_healthy/perfusion.xdmf --occluded ./results/p0000/perfusion_LMCAo/perfusion.xdmf
...
python3 -m src.Legacy_version.io.convert_res2img --config_file ./results/p0000/perfusion_RMCAo/settings.yaml
...
mpirun -n 6 python3 -m src.Legacy_version.simulation.infarct_calculation_thresholds --config_file ./configs/config_basic_flow_solver_RMCAo.yaml --baseline ./results/p0000/perfusion_healthy/perfusion.xdmf --occluded ./results/p0000/perfusion_RMCAo/perfusion.xdmf
